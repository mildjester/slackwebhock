...
try{
	if ($argc !== 3) {
		...
		echo '<<Usage>>'.PHP_EOL;
		echo '    php SlackWebHockCli.php {target channnel or user} {message text}'.PHP_EOL;
		echo '<<Example>>'.PHP_EOL;
		echo '    php SlackWebHockCli.php #general TestMessage'.PHP_EOL;
		echo '    php SlackWebHockCli.php @david "you are fired"'.PHP_EOL;
		echo PHP_EOL;
		exit;
	}
